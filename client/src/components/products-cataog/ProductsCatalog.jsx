            ...
            {pending ? (
                ...
                <div className="flex justify-center items-center h-64">
                    <div className="flex flex-col justify-center items-center h-64 bg-gray-100 rounded-lg shadow-md p-6">
                        ...
                        <p className="text-gray-600 text-xl font-semibold">No products available</p>
                        <p className="text-gray-500 text-sm mt-2">Check back later or explore other categories.</p>
                        <Link to="/products/add" className="mt-4 px-6 py-2 bg-green-600 text-white rounded-lg shadow hover:bg-green-700 transition">
                            Add a Product
                        </Link>
                    </div>
                </div>
